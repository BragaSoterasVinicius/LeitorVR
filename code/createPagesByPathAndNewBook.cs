...
using TMPro;
public class createPagesByPathAndNewBook : MonoBehaviour
{
    ...
    public void LoadBook(string libpath, GameObject debugReader, GameObject bookfather, float distanceAmongPages = 0.01f)
    {
        ...
        debugReader.GetComponent<TextMeshPro>().text += "TotalFolderFiles: " + TotalFolderFiles;
        ...
        for (int i = 0; i < TotalFolderFiles; i++)
        {
            ...
            string imagePath = (libpath + "/page_" + i + ".jpg");
            Debug.Log("imagePath: " + imagePath);
            Debug.Log("Vai começar a coroutine");
